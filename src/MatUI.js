...
export default function MatUI() {
  ...
  return (
    <>
      ...
      <Button variant="text" startIcon={<DeleteIcon />} sx={{m:1}}>Text</Button>
      <Button color="success" endIcon={<SendIcon />} sx={{m:1}} variant="contained">Contained</Button>
      <Button color="error" sx={{m:1}} variant="outlined">Outlined</Button>
      <Button 
        component="label" 
        role={undefined} 
        variant="contained" 
      ...
      <CustomBtnStyle sx={{m:2}}>Custom Button</CustomBtnStyle>
